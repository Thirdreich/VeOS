...
.callback(function() {
	...
	.html('Vlaicu: <input value="Vlaicu" type="radio" name="theme"><img class="" src="webdows/resources/explorer/webdows/thumbnail.png"><br><input type="color" title="Pick a theme color"><button class="bac" title="Pick a background">Background</button><button class="sav">Save</button><button class="app">Apply</button><button class="can">Cancel</button>')
	.find('img')
